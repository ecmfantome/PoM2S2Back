...
public class DevoirRenduExceptionHandler {

    @ExceptionHandler(DevoirRenduNotFoundException.class)
    public ResponseEntity<ErrorResponseApi> handleDevoirRenduExceptionHandler(DevoirRenduNotFoundException ex) {
